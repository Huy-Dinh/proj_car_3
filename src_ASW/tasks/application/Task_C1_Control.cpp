...
static const PxProtectRegion_T Task_C1_Control_Regions[] = {
	...
	//TODO: Currently moved the global GPT timer ticks variable here. Need to be discussed with Prof.
	...
	//The RTE ring bufer for the tasks belongs to Core 1 is in this region, Canopen data dictionary etc.
	...
	{ (PxUInt_t) __CPU0_SL_SAFETY_BEGIN, (PxUInt_t) __CPU0_SL_SAFETY_END, (PxProtectType_t)WRProtection},    //Todo Hack - will be replaced with messages lateron
...
//		RT_cyclicRunExecute(RT_C1_control_cyclicRunTable, RT_C1_control_cyclicRunTable_size, count, 0, myID, 0, eRTE_TaskC1ControlTimings_idx);
		...
		PxAwaitEvents(ev_Task_C1_Control_0_1ms);
	}
}
