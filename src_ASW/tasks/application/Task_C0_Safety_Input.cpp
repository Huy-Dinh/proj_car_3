...
static const PxProtectRegion_T Task_C0_Safety_Input_Regions[] = {
		...
		//{ (PxUInt_t) PORT_CAN_BEGIN, (PxUInt_t) PORT_CAN_END, (PxProtectType_t)WRProtection},
	...
	//rte_time buffer for safety input task lies in CPU0 data pool.
...
void CTask_C0_Safety_Input::Task_Func(PxTask_t myID, PxMbx_t myMailbox, PxEvents_t myActivationEvents)
{
	...
	while (1)
	{
		...
		//Call all state independand runnables
		...
		//Call all runnables for PreRun State
