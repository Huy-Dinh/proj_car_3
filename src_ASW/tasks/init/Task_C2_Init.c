...
PxAligned_t Task_C2_Init_stack[TASK_C2_INIT_STACKSIZE_CORE2];
PxAligned_t Task_C2_Init_intstack[TASK_C2_INIT_INTSTACKSIZE_CORE2];
static PxChar_t	Task_C2_Init_stack__protectionPad[6] __attribute__ ((aligned(8)));
#pragma section
...
static const PxTaskContext_T InitTaskContext_CORE2 = {
	...
	.protection[1] =
	{
	    .lowerBound = (PxUInt_t)&Task_C2_Init_stack,
        .upperBound = (PxUInt_t)&Task_C2_Init_stack__protectionPad[0],
        .prot 		= WRProtection
	}
...
const PxTaskSpec_T InitTaskSpec_CORE2 =
{
		...
		.ts_taskstack =
		{
			...
			.stk_src.stk = &Task_C2_Init_stack[TASK_C2_INIT_STACKSIZE_CORE2]
		},
		.ts_inttaskstack =
		{
			.stk_type = PXStackFall,
			.stk_size = PXStackDontCheck,
			.stk_src.stk = &Task_C2_Init_intstack[TASK_C2_INIT_INTSTACKSIZE_CORE2]
		},
		.ts_abortstacksize = 0
