...
PxAligned_t Task_C1_Init_stack[TASK_C1_INIT_STACKSIZE_CORE1];
PxAligned_t Task_C1_Init_intstack[TASK_C1_INIT_INTSTACKSIZE_CORE1];
static PxChar_t	Task_C1_Init_stack__protectionPad[6] __attribute__ ((aligned(8)));
#pragma section
...
static const PxTaskContext_T InitTaskContext_CORE1 = {
	.protection[0] =
	{
	    .lowerBound = PxTricSystemRodataLowerBound,
        .upperBound = PxTricSystemRodataUpperBound,
        .prot 		= ReadProtection
	}
	,
	.protection[1] =
	{
	    .lowerBound = (PxUInt_t)&Task_C1_Init_stack,
        .upperBound = (PxUInt_t)&Task_C1_Init_stack__protectionPad[0],
        .prot 		= WRProtection
	}
...
const PxTaskSpec_T InitTaskSpec_CORE1 =
{
		...
		.ts_taskstack =
		{
			...
			.stk_src.stk = &Task_C1_Init_stack[TASK_C1_INIT_STACKSIZE_CORE1]
		},
		.ts_inttaskstack =
		{
			.stk_type = PXStackFall,
			.stk_size = PXStackDontCheck,
			.stk_src.stk = &Task_C1_Init_intstack[TASK_C1_INIT_INTSTACKSIZE_CORE1]
		},
		.ts_abortstacksize = 0
