...
PxAligned_t Task_C0_Init_stack[TASK_C0_INIT_STACKSIZE_CORE0];
PxAligned_t Task_C0_Init_intstack[TASK_C0_INIT_INTSTACKSIZE_CORE0];
static PxChar_t	Task_C0_Init_stack__protectionPad[6] __attribute__ ((aligned(8)));
#pragma section
...
static const PxProtectRegion_T InitTaskRegions_CORE0[] = {
		...
		//All the 3 cores cash access is given to access the ring buffers belonging to ach of the cores
		/*Added by Shrikant*/		{ (PxUInt_t) __CPU0_DATAPOOL_BEGIN, (PxUInt_t) __CPU0_DATAPOOL_END, (PxProtectType_t)WRProtection},
		/*Added by Shrikant*/		{ (PxUInt_t) __CPU1_DATAPOOL_BEGIN, (PxUInt_t) __CPU1_DATAPOOL_END, (PxProtectType_t)WRProtection},
		/*Added by Shrikant*/		{ (PxUInt_t) __CPU2_DATAPOOL_BEGIN, (PxUInt_t) __CPU2_DATAPOOL_END, (PxProtectType_t)WRProtection},
	//Complete peripheral section
	{ (PxUInt_t) PERIPHERAL_START, (PxUInt_t) PERIPHERAL_END, (PxProtectType_t)WRProtection},

	//Global system (PXROS) memory
	{ (PxUInt_t) GLOBAL_SYSTEM_RAM_BEGIN, (PxUInt_t) GLOBAL_SYSTEM_RAM_END, (PxProtectType_t)WRProtection},
	...
	//Nameserver Memory - needed? Or handled by the Kernel?
	//{ (PxUInt_t) PxNameServerSpaceBase, (PxUInt_t) PxNameServerSpaceEnd, (PxProtectType_t)WRProtection},
...
static const PxTaskContext_T InitTaskContext_CORE0 = {
	...
	.protection[1] =
	{
	    .lowerBound = (PxUInt_t)&Task_C0_Init_stack,
        .upperBound = (PxUInt_t)&Task_C0_Init_stack__protectionPad[0],
        .prot 		= WRProtection
	}
...
const PxTaskSpec_T InitTaskSpec_CORE0 =
{
		...
		.ts_taskstack =
		{
			...
			.stk_src.stk = &Task_C0_Init_stack[TASK_C0_INIT_STACKSIZE_CORE0]
		},
		.ts_inttaskstack =
		{
			.stk_type = PXStackFall,
			.stk_size = PXStackDontCheck,
			.stk_src.stk = &Task_C0_Init_intstack[TASK_C0_INIT_INTSTACKSIZE_CORE0]
		},
		.ts_abortstacksize = 0
 ...
 *******************************************************************************************************/
	...
	{
		DET_stop(0,CREATENAMESERVER, result);
	}
#endif
	...
	{
		DET_stop(0,CREATERELEASESERVER, result);
	}
