...
void LIDAR_run_checkFullScan()
{
	...
	//Let's do some magic feature extraction
	LIDARFEATURE_data_t lidarFeature;
	 //Run your algorithm, setting lidarFeature

	result = LIDARFEATURE_set(&so_lidarfeature, lidarFeature);
