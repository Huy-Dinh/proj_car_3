...
void REMOTE_init()
{
	REMOTE_data_t remote_sendData = REMOTE_INIT_DATA;
	...
	REMOTE_write(&so_out_remote, remote_sendData);
...
RT_safety_t REMOTE_run_readAndCheckProtocol()
{
	...
	REMOTE_data_t remote_recievedData;
	...
	remote_sig_status = REMOTE_get_with_status(&so_in_remote, &remote_recievedData);
