...
REMOTE_flush_channel_t opl_remote[] = 
{
...
ENGINEDECODER_CREATE_SIGNAL( 
   ...
   /* refresh Index */      0,
   /* refresh function */   CANOPEN_read_DecoderFromFaulhaber,
   /* flush list */         0,
   /* section RAM memory */ .sl_safety,
   /* section ROM memory */ .rodata
...
{
    /* remote protocol via message handler */		{ 1, MSG_write_remoteToCom },
    /* end of list                    */		{ 0, 0 } 
};   /* Outportlist opl_remoteMsgFromState */
#pragma section 
...
{
    /* remote protocol via message handler */		{ 2, MSG_write_remoteToCom },
    /* end of list                    */		{ 0, 0 } 
};   /* Outportlist opl_remoteMsgFromControl */
#pragma section 
...
void SL_SAFETY_init()
{
    REMOTE_init( &so_in_remote, REMOTE_INIT_DATA);
    REMOTE_init( &so_out_remote, REMOTE_INIT_DATA);
...
{
    REMOTE_inc_age( &so_in_remote, SL_SAFETY_TICKTIME);
    REMOTE_inc_age( &so_out_remote, SL_SAFETY_TICKTIME);
