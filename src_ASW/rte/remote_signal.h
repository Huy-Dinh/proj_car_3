...
*  file    REMOTE.h
*
*  brief   signal base class for signal REMOTE
*
...
*/
//#define SIG_NO_CONV( REMOTE_data_t )
//STATIC_INLINE REMOTE_data_t REMOTE_data_t##_NO_CONV( REMOTE_data_t val )
//{
//   return val;
//}
 ...
 */
typedef RC_t   (*REMOTE_scl_to_val_func_t)( const REMOTE_raw_t * const, REMOTE_data_t * const);

/**
 * Function pointer type for scaling application data to raw data
 */
typedef RC_t   (*REMOTE_scl_to_raw_func_t)( const REMOTE_data_t * const, REMOTE_raw_t * const);
 ...
 *  I-Port
 */
typedef RC_t       (*REMOTE_refresh_func_t   )(       REMOTE_raw_t * const, const SIG_IDX_TYPE );

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t       (*REMOTE_flush_func_t     )( const REMOTE_raw_t * const, const SIG_IDX_TYPE );
...
/**
 *  Instances of structure REMOTE_flush_channel_t represent a flushable driver output channel.
...
struct REMOTE_flush_channel_s
{
     ...
     */
    REMOTE_flush_func_t const flush_func;
};                                                                                                                     
typedef SIG_CONST struct REMOTE_flush_channel_s SIG_CONST_SIZE_OPTIMIZATION REMOTE_flush_channel_t;
                                                                                                                       
/**
 *  Instances of the structure REMOTE_cfg_t represent the signal configuration object.
 *
 ...
 * of flushable channels. Flush channels have to be instances of the structure 'REMOTE_flush_channel_t' (for further
...
struct REMOTE_cfg_s
{
	 ...
	 */
    REMOTE_scl_to_val_func_t const        scl_to_val_func;
	/**
	 * Pointer to the d2r scaler. NULL, if class default scaler will be used
	 */
    REMOTE_scl_to_raw_func_t const        scl_to_raw_func;
     ...
     */
    REMOTE_refresh_func_t const           refresh_func;

    /**
     * Pointer to the output driver table
     */
   const REMOTE_flush_channel_t * const  p_flush_channel_table;

#ifdef TOGETHER
   /**
    * @link association 
    */
   REMOTE_scaler lnkREMOTE_scaler;
   /**@link aggregation*/
   REMOTE_flush_channel_s lnkREMOTE_flush_channel_s;
#endif
};                                                                                                                     
typedef SIG_CONST struct REMOTE_cfg_s SIG_CONST_SIZE_OPTIMIZATION SIG_CFG_SECTION REMOTE_cfg_t;
 ...
 **/
typedef uint16_t REMOTE_time_t;
                                                                                                                       
/**
 *  Definiton of local signal types which can be used to avoid refering the real datatypes TYPE and $Type_raw\$.
 */
typedef REMOTE_data_t REMOTE_value_t;
typedef REMOTE_raw_t REMOTE_raw_value_t;
							  
/**
 *  Instances of the struct REMOTE_t represent the signal objects.
...
{                                                                                                                      
   ...
   const REMOTE_cfg_t * const    p_sig_cfg;
#ifdef TOGETHER
   /**@link aggregation*/
   REMOTE_cfg_s lnkREMOTE_cfg_s;
#endif

#ifndef TOGETHER
};                                                                                                                     
typedef struct REMOTE_s SIG_DATA_SIZE_OPTIMIZATION REMOTE_t;
#endif                                                                                                                       
 ...
 *
 * @param  REMOTE_t * const signal: Pointer to the signal object which will be initialised
 * @param const REMOTE_data_t value: Initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
STATIC_INLINE RC_t REMOTE_init(       REMOTE_t * const signal
                             , const REMOTE_data_t       value )
{                                                                                                                      

   RC_t ret = RC_SUCCESS;

   const REMOTE_cfg_t * const p_sig_cfg = signal->p_sig_cfg;

   REMOTE_raw_t raw_value = signal->raw_value;
 ...
 *
 * @param  REMOTE_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
STATIC_INLINE sig_sts_t REMOTE_get_status( const REMOTE_t * const signal )
{
 ...
 *
 **/
STATIC_INLINE boolean_t REMOTE_is_status_invalid( const REMOTE_t * const signal )
{
 ...
 * @return RC_t: standard return code, currently only RC_SUCCESS
 */
STATIC_INLINE RC_t REMOTE_set_status_invalid( REMOTE_t * const signal )
{
 ...
 *
 */
STATIC_INLINE RC_t REMOTE_set_status(        REMOTE_t * const signal
 ...
 *
 * @param  REMOTE_t * const signal: Pointer to the signal object
 * @return REMOTE_time_t: Number of cycles since the signal has bee refreshed for the last time
 */
STATIC_INLINE REMOTE_time_t REMOTE_get_age( const REMOTE_t * const signal )
{
   return signal->age;
}
 ...
 * @param  REMOTE_t * const signal: Pointer to the signal object
 * @param REMOTE_time_t increment: incrementvalue, typically in [ms]
 * @return void
 */
STATIC_INLINE void REMOTE_inc_age(  REMOTE_t * const signal , REMOTE_time_t increment)
{
 ...
 */
STATIC_INLINE REMOTE_time_t REMOTE_get_time_remaining( const REMOTE_t * const signal, REMOTE_time_t timeout )
{
 ...
 *
**/
STATIC_INLINE boolean_t REMOTE_is_new( const REMOTE_t * const signal )
{
	   //Todo: Added status check, correct?
	   return (boolean_t)(signal->status == SIG_STS_VALID && signal->age == (REMOTE_time_t)0);
}
 ...
 *
 * @param  REMOTE_t * const signal: Pointer to the signal object
 * @return REMOTE_data_t: current value of the application data buffer
 *
 **/
STATIC_INLINE REMOTE_data_t REMOTE_get( const REMOTE_t * const signal )
{                                                                                                                      
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  REMOTE_t * const signal: Pointer to the signal object
 * @param  REMOTE_data_t * const value: Pointer for the application data value
 * @return sig_status_t: signal status
 *
 **/
STATIC_INLINE sig_sts_t REMOTE_get_with_status( const REMOTE_t * const signal
                                           ,       REMOTE_data_t * const value  )
{                                                                                                                      
   *value = signal->value;                                                                                             
   return signal->status;
}                                                                                                                      
 ...
 *
 * @param  REMOTE_t * const signal: Pointer to the signal object
 * @param  REMOTE_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
STATIC_INLINE RC_t REMOTE_set(       REMOTE_t * const signal
                           , const REMOTE_data_t value  )
{
   ...
   //Increment the age
   //REMOTE_inc_age(signal); //Taken out to support time triggered increment of age
 ...
 *
 * @param  REMOTE_t * const signal: Pointer to the signal object
 * @return REMOTE_raw_t: current value of the raw data buffer
 */
STATIC_INLINE REMOTE_raw_t REMOTE_get_raw( const REMOTE_t * const signal )
{                                                                                                                      
 ...
 *
 * @param  REMOTE_t * const signal: Pointer to the signal object
 * @param  REMOTE_raw_t * const raw_value : Pointer for returning the current value of the raw data buffer
 * @return sig_status_t: signal status
 *
 **/
STATIC_INLINE sig_sts_t REMOTE_get_raw_with_status( const REMOTE_t * const signal
                                               ,       REMOTE_raw_t * const raw_value )
{                                                                                                                      
 ...
 *
 * @param  REMOTE_t * const signal: Pointer to the signal object
 * @param const REMOTE_raw_t raw_value: Raw value which will be stored in the daw data buffer. The application value will be updated afterwards
 * @return RC_t: standard return code, currently only RC_SUCCESS
 */
STATIC_INLINE RC_t REMOTE_set_raw(       REMOTE_t * const signal
                               , const REMOTE_raw_t         raw_value )
{
   ...
   REMOTE_data_t value = signal->value;
 ...
 *
 */
STATIC_INLINE RC_t REMOTE_refresh( REMOTE_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {                                                                                                                   
      REMOTE_raw_t raw_value  = signal->raw_value; // Todo: Critical section for complex datatypes.
 ...
 *
 **/
STATIC_INLINE RC_t REMOTE_flush( const REMOTE_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   const REMOTE_flush_channel_t * p_flush_channel =
                                            (const REMOTE_flush_channel_t *)(signal->p_sig_cfg->p_flush_channel_table);
                                                                                                                       
   if ( ! REMOTE_is_status_invalid( signal ) )
   {                                                                                                                   
      ...
      {                                                                                                                
         while ( NULL != p_flush_channel->flush_func )                                                                 
         {
            ...
            if ( p_flush_channel->flush_func( (const REMOTE_raw_t * const)&(signal->raw_value)
 ...
 *
 * @param REMOTE_t * const signal: Pointer to the signal object
 * @param REMOTE_data_t * const value: Pointer for returning the application value
 * @return  RC_t: Return value of the driver call
 *
 **/
STATIC_INLINE RC_t REMOTE_read( REMOTE_t * const signal
                            ,     REMOTE_data_t * const value  )
{                                                                                                                      
   RC_t ret = REMOTE_refresh( signal );
   *value = REMOTE_get( signal );
   return ret;                                                                                                         
}                                                                                                                      
 ...
 *
 **/
STATIC_INLINE RC_t REMOTE_read_with_status(  REMOTE_t * const signal
                                     , REMOTE_data_t * const value
                                     , sig_sts_t* const status    )
{                                                                                                                      
   RC_t ret = REMOTE_refresh( signal );
   *status   = REMOTE_get_with_status( signal, value );
   return ret;                                                                                                         
}                                                                                                                      
 ...
 *
 * @param REMOTE_t * const signal: Pointer to the signal object
 * @param REMOTE_raw_t * const raw_value: Pointer for returning the raw data value
 * @return  RC_t: Return value of the driver call
 *
 **/
STATIC_INLINE RC_t REMOTE_read_raw( REMOTE_t * const signal
                                , REMOTE_raw_t * const raw_value )
{                                                                                                                      
   RC_t ret     = REMOTE_refresh( signal );
   *raw_value = REMOTE_get_raw( signal );
   return ret;                                                                                                         
}                                                                                                                      
 ...
 *
 **/
STATIC_INLINE RC_t REMOTE_read_raw_with_status(  REMOTE_t * const signal
                                         ,  REMOTE_raw_t * const raw_value
                                         , sig_sts_t* const status       )
{                                                                                                                      
   RC_t ret = REMOTE_refresh( signal );
   *status   = REMOTE_get_raw_with_status( signal, raw_value );
   return ret;                                                                                                         
}                                                                                                                      
 ...
 *
 * @param REMOTE_t * const signal: Pointer to the signal object
 * @param const REMOTE_data_t value: The new value for the application data buffer
 * @return  RC_t: Return value of the driver call
 *
 **/
STATIC_INLINE RC_t REMOTE_write(       REMOTE_t * const signal
                             , const REMOTE_data_t             value  )
{                                                                                                                      
   RC_t ret = REMOTE_set( signal, value );
                                                                                                                       
   if ( ret == RC_SUCCESS )                                                                                            
   {                                                                                                                   
      ret = REMOTE_flush( signal );
   }                                                                                                                   
 ...
 *
 * @param REMOTE_t * const signal: Pointer to the signal object
 * @param const REMOTE_raw_t raw_value: new raw value
 * @return  RC_t: Return value of the driver call
 *
 */
STATIC_INLINE RC_t REMOTE_write_raw(       REMOTE_t * const signal
                                 , const REMOTE_raw_t         raw_value )
{                                                                                                                      
   RC_t ret = REMOTE_set_raw( signal, raw_value );
 ...
 *
 * @param REMOTE_t * const * const p_signal_list: Pointer to the signal list
 * @return RC_t: RC_SUCCESS if all calls have been successful, RC_ERROR otherwise
 */
STATIC_INLINE RC_t REMOTE_refresh_all( REMOTE_t * const * const p_signal_list )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   REMOTE_t * const * p_elem = (REMOTE_t * const *)p_signal_list;
                                                                                                                       
   while ( NULL != *p_elem )                                                                                           
   {                                                                                                                   
      if ( REMOTE_refresh( (REMOTE_t * const)(*p_elem) ) != RC_SUCCESS )
      {                                                                                                                
         ret = RC_ERROR;                                                                                               
      }                                                                                                                
      p_elem++;                                                                                                        
 ...
 *
 */
STATIC_INLINE RC_t REMOTE_flush_all( REMOTE_t * const * const p_signal_list )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   const REMOTE_t * const * p_elem = (const REMOTE_t * const *)p_signal_list;
                                                                                                                       
   while ( NULL != *p_elem )                                                                                           
   {
	   //Todo: add other return code error handling
      if ( REMOTE_flush( (const REMOTE_t * const)(*p_elem) ) != RC_SUCCESS )
      {                                                                                                                
         ret = RC_ERROR;                                                                                               
      }                                                                                                                
      p_elem++;                                                                                                        
...
#define REMOTE_CREATE_SIGNAL(																	    \
						 ...
						 , MEMROM)																	\
                                                                                                    \
static const REMOTE_cfg_t SIGNAL_NAME##_cfg __attribute__ ((section ( #MEMROM )))=				    \
{                                                                                                   \
   SCL_RAW_TO_VAL,                                                                                  \
   SCL_VAL_TO_RAW,                                                                                  \
   REFRESH_IDX,                                                                                     \
   ...
   FLUSH_CHANNEL_TABLE                                                                              \
																									...
																									\
REMOTE_t SIGNAL_NAME __attribute__ ((section ( #MEMRAM )))=										\
{                                                                                                   \
   INIT_VALUE,                                                                                      \
   INIT_RAW_VALUE,                                                                                  \
   SIG_STS_STARTUP,                                                                                 \
