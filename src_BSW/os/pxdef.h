...
/* 35 */	PXERR_MSG_ABORTED	/*"Message command aborted"*/,
/* 36 */	PXERR_MSG_ILLMSG	/*"Invalid message `%d'"*/,
/* 37 */	PXERR_MSG_ILLOWNER	/*"Invalid message owner `%d'"*/,
/* 38 */	PXERR_MSG_ILLSIZE	/*"Message size would exceed buffer size"*/,
/* 39 */	PXERR_MSG_ILLUSER	/*"Invalid user `%d' for message `%d'"*/,
/* 40 */	PXERR_MSG_NOMSG	/*"Insufficient memory to satisfy message request"*/,
/* 41 */	PXERR_MSG_NOT_IMPLEMENTED	/*"request not implemented"*/,
/* 42 */	PXERR_MSG_RELMBX_INSTALLED	/*"release mailbox already installed"*/,
/* 43 */	PXERR_MSG_NOT_CLOSED	/*"message was not closed before open"*/,
/* 44 */	PXERR_MSG_ILL_NEW_DATA	/*"Illegal new message data pointer"*/,
/* 45 */	PXERR_MSG_ILL_ALIGN	/*"Illegal aligned data pointer for PxMsgEnvelop"*/,
/* 46 */	PXERR_MSG_ILL_SIZE	/*"Illegal data size for PxMsgEnvelop"*/,
/* 47 */	PXERR_OBJ_ABORTED	/*"Object command aborted"*/,
/* 48 */	PXERR_OBJ_ILLOBJ	/*"Invalid object `%d'"*/,
/* 49 */	PXERR_OBJ_NOOBJ	/*"No object available to satisfy request"*/,
/* 50 */	PXERR_OPOOL_ILLCAPACITY	/*"Insufficient capacity in source object pool"*/,
/* 51 */	PXERR_OPOOL_ILLDELETE	/*"Object pool delete failed: no superior object pool"*/,
/* 52 */	PXERR_OPOOL_ILLOPOOL	/*"Invalid object pool `%d'"*/,
/* 53 */	PXERR_OPOOL_ILLSRC	/*"Source of a real object pool must be real"*/,
/* 54 */	PXERR_OPOOL_ILLTYPE	/*"Invalid object pool type"*/,
/* 55 */	PXERR_OPOOL_TASKWAITS	/*"Object pool delete failed: task(s) waiting at object pool"*/,
/* 56 */	PXERR_PE_ILLPE	/*"Perodic: invalid reference to a periodic object"*/,
/* 57 */	PXERR_PXHND_ILLCALL	/*"PXROS handler service called by task or interrupt handler"*/,
/* 58 */	PXERR_SELF_ABORTED	/*"Request aborted"*/,
/* 59 */	PXERR_TASK_RETURNS	/*"Task %d  returns without `PxExit'"*/,
/* 60 */	PXERR_TASK_DYING_WHILE_IN_USE	/*"Dying task still in use"*/,
/* 61 */	PXERR_TASK_DIESRV_INITIALIZED	/*"Exitserver already initialized"*/,
/* 62 */	PXERR_TASK_DIESRV_NOT_INITED	/*"Exitserver not yet initialized"*/,
/* 63 */	PXERR_TASK_ILLCALL	/*"Task service called by handler"*/,
/* 64 */	PXERR_TASK_ILLPRIO	/*"Invalid priority `%d >= %d'"*/,
/* 65 */	PXERR_TASK_ILLRDYFUN	/*"Invalid ready function detected"*/,
/* 66 */	PXERR_TASK_ILLSTACKSPECTYPE	/*"Invalid stack type `%d'"*/,
/* 67 */	PXERR_TASK_ILLTASK	/*"Invalid task `%d'"*/,
/* 68 */	PXERR_TASK_SCHEDEXT_NOT_CONFIGURED	/*"Task extensions not configured in this PXROS version"*/,
/* 69 */	PXERR_TASK_STACKOVERFLOW	/*"Stack overflow for task `%d'"*/,
/* 70 */	PXERR_TASK_STACKUNKNOWN	/*"Stack begin could not be determined: specify stack size"*/,
/* 71 */	PXERR_TASK_STKMEM	/*"Insufficient memory to allocate task stack"*/,
/* 72 */	PXERR_TASK_TCBMEM	/*"Insufficient memory to allocate task control block"*/,
/* 73 */	PXERR_TASK_ILLPRIV	/*"Illegal privilege for tasks"*/,
/* 74 */	PXERR_TASK_STACK_SEGBOUNDARY	/*"Task stack `%p[%x]' crosses segment boundary"*/,
/* 75 */	PXERR_TASK_STACK_ILLALIGN	/*"Invalid task stack alignment `%p[%x]'"*/,
/* 76 */	PXERR_TO_ILLTO	/*"Timeout: invalid reference to a timeout object"*/,
/* 77 */	PXERR_TRACE_ILLCTRL	/*"Invalid trace control"*/,

/* 78 */	PXERR_NAME_UNDEFINED	/*"Nameserver: name not defined"*/,
/* 79 */	PXERR_NAME_BUFOVERFLOW	/*"Nameserver: information buffer too small"*/,
/* 80 */	PXERR_NAME_DEFINED	/*"Nameserver: name already defined -- use `PxNameRedefine'"*/,
/* 81 */	PXERR_NAME_MEM	/*"Nameserver: memory shortage"*/,
/* 82 */	PXERR_NAME_ILL_REQUEST	/*"Nameserver: illegal nameserver request"*/,
/* 83 */	PXERR_NAME_NOT_INITIALIZED	/*"Nameserver: not yet initialized"*/,

/* 84 */	PXERR_MSGREL_INITED	/*"MsgRelServer: already initialized"*/,
/* 85 */	PXERR_MSGREL_NOT_INITED	/*"MsgRelServer: not yet initialized"*/,

/* 86 */	PXERR_MEMORY_SHORTAGE	/*"Memory shortage"*/,
/* 87 */	PXERR_OBJECT_SHORTAGE	/*"Object shortage"*/,
/* 88 */	PXERR_RESOURCE_SHORTAGE	/*"Resource shortage"*/,
/* 89 */	PXERR_CONNECTION_FAILED	/*"Connection failed"*/,
/* 90 */	PXERR_COMMUNICATION_FAILED	/*"Communication failed"*/,
/* 91 */	PXERR_REQUEST_FAILED	/*"Request failed"*/,
/* 92 */	PXERR_REQUEST_ILLEGAL	/*"Request illegal"*/,
/* 93 */	PXERR_REQUEST_INVALID	/*"Request invalid"*/,
/* 94 */	PXERR_REQUEST_INVALID_PARAMETER	/*"Request with invalid parameter"*/,
/* 95 */	PXERR_REQUEST_INVALID_CONTEXT	/*"Request in invalid context"*/,
/* 96 */	PXERR_REQUEST_CONFIGURATION_LIMITATION	/*"Request exceeds some configuration limitation"*/,
/* 97 */	PXERR_REQUEST_IMPLEMENTATION_RESTRICTION	/*"Request violates some implementation restriction"*/,
/* 98 */	PXERR_REQUEST_TIMEOUT	/*"Request timed out"*/,
/* 99 */	PXERR_REQUEST_ABORTED	/*"Request aborted"*/,
/* 100 */	PXERR_REQUEST_CANCELED	/*"Request canceled"*/,
/* 101 */	PXERR_SERVICE_NOT_CONFIGURED	/*"Service %d has not been configured into your PXROS"*/,
/* 102 */	PXERR_ILLEGAL_SERVICE_CALLED	/*"Service %d is not defined in PXROS"*/,
/* 103 */	PXERR_PROT_NOFREE_ENTRY	/*"no free protection entry"*/,
/* 104 */	PXERR_PROT_ILL_HANDLE	/*"illegal protection handle %d"*/,
/* 105 */	PXERR_PROT_ILL_REGION	/*"illegal protection region definition"*/,
/* 106 */	PXERR_PROT_PERMISSION	/*"Tried to set a protection without permission"*/,
/* 107 */	PXERR_ILLEGAL_ACCESS	/*"Access through parameter pointer %p in size %d is illegal"*/,
/* 108 */	PXERR_ACCESS_RIGHT	/*"No access right for this service"*/,
/* 109 */	PXERR_SYSJOBLIST_INCONSISTENCY	/*"Inconsistency in the system job list"*/,
/* 110 */	PXERR_GLOBAL_SYSJOBLIST_INCONSISTENCY	/*"Inconsistency in the global system job list"*/,
/* 111 */	PXERR_GLOBAL_MSG_RELMBX_NOT_INSTALLED	/*"release mailbox for global messages not installed"*/,
/* 112 */	PXERR_GLOBAL_ILLEGAL_CORE	/*"access illegal core"*/,
/* 113 */	PXERR_GLOBAL_OBJLIST_INCONSISTENCY	/*"Inconsistency between local and global object list initialization"*/,
...
/* Core definitions */
/* replaced by PX_NO_OF_CORES and PX_CORE_x
#define CORE_COUNT 3
#define CORE_0	0
#define CORE_1	1
#define CORE_2	2
...
static inline TC_CSA_t *CSA2PTR(PxPCXI_t csa)
{
    TC_CSA_t *pcsa;
    __asm__ volatile (
...
extern "C"
{
    ...
    extern PxError_t PxObjGetName(PxObjId_t, PxChar_t *b, PxUInt_t);
    extern PxError_t PxObjSetName(PxObjId_t, const PxChar_t PXDptr_q *, PxUInt_t);
...
extern PxError_t PxDelayResched_Pxhnd(PxDelay_t delay, PxTicks_t ticks,
...
extern "C"
{
    ...
    extern PxSize_t PxMcGetVarsizedOverhead(void);
...
extern "C"
{
    ...
    extern PxError_t PxTaskSuspend_Pxhnd(PxTask_t);
    ...
    extern PxError_t PxTaskSignalEvents_Pxhnd(PxTask_t task, PxEvents_t events);
...
extern PxToEvent_t PXFun_q PxToRequest_EvWait( PxOpool_t , PxTicks_t, PxEvents_t, PxEvents_t);
...
extern PxPeEvent_t PXFun_q PxPeRequest_EvWait( PxOpool_t, PxTicks_t, PxEvents_t, PxEvents_t);
...
/* the right to define new resources, i.e. new objectpools and
 memory classes
 */
#define PXACCESS_NEW_RESOURCES		(1<<6)

/* the right to execute special system function like PxTaskSuspend which can influence
 the system behaviour, PxSetMessagefun
 */
#define PXACCESS_SYSTEM_CONTROL         (1<<7)

/* the right for a task to set modebits
 */
#define PXACCESS_MODEBITS         (1<<8)

/* the right to override the aborting events if not set an aborting event
 * from PxExpectAbort cannot be caught by a nested AwaitEvents call
 */
...
/* the right for a task to set it's priority to a higher priority than the one it has been created with
*/

#define PXACCESS_TASK_SET_HIGHER_PRIO   (1<<12)

/* the right for a task to change it's priority even to a lower priority than the one it has been created with
*/

#define PXACCESS_CHANGE_PRIO   (1<<13)
/* the right for a task to set it's access rights to those it has been created with
*/
...
/*! enables monitoring of variable sized
 memory blocks:
 these blocks are then linked into the
 memory class they are taken from
 and the requesting task is recorded
 increases the overhead per block by
 3 pointers and an integer
 */
...
#ifdef __TC161__
extern PxError_t PxGetGlobalServerMbx(PxUInt8_t ServerCore, PxMbxReq_t);
#endif
...
#define PXIntMaxIntno		(PxInt_Max_Intrs)
    ...
    {
        PxBool_t
        (*hnd_handler)(PxUInt_t trapno, PxUInt_t tin, PxUInt_t hnd_arg, PxUInt_t runtaskId,
                       TC_CSA_t *csa);
        PxUInt_t hnd_arg;
    } PxTrapHnd_arg;
    ...
    /* the same for traps. Trap handler gets 5 arguments. The
     * trap number,
     * TIN
     ...
     */
    PxError_t
    PxTrapInstallHandler(PxUInt_t trapno, PxBool_t(* traphandler)(PxUInt_t, PxUInt_t, PxUInt_t,
                                                                  PxUInt_t, TC_CSA_t *) __attribute__ ((interrupt_handler)),
                         PxUInt_t arg);
    ...
    extern void __class_0_trap_handler(int) __attribute__ ((interrupt_handler));
    extern void __class_1_trap_handler(int) __attribute__ ((interrupt_handler));
    extern void __class_2_trap_handler(int) __attribute__ ((interrupt_handler));
    extern void __class_3_trap_handler(int) __attribute__ ((interrupt_handler));
    extern void __class_4_trap_handler(int) __attribute__ ((interrupt_handler));
    extern void __class_5_trap_handler(int) __attribute__ ((interrupt_handler));
    extern void __class_6_trap_handler(int) __attribute__ ((interrupt_handler));
    extern void __class_7_trap_handler(int) __attribute__ ((interrupt_handler));
