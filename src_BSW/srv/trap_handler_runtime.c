...
#define TRAP_STORE_DETAILS																\
	...
	TRAP_RUNTIME_DETAIL[__MFCR(CPU_CORE_ID)].DSTR.U=__MFCR(CPU_DSTR);						\
	TRAP_RUNTIME_DETAIL[__MFCR(CPU_CORE_ID)].DATR.U=__MFCR(CPU_DATR);						\
	TRAP_RUNTIME_DETAIL[__MFCR(CPU_CORE_ID)].DEADD.U=__MFCR(CPU_DEADD);					\
...
static void trap_entry_hook(PxUInt_t trapclass, PxUInt_t tin , PxUInt_t task_id, PxUInt_t arg,	TC_CSA_t* p_CSA){
	TRAP_STORE_DETAILS
}
...
/* TRAP CLASS -	0	*/
PxBool_t Px_trap_hdl_0(PxUInt_t trapclass, PxUInt_t tin , PxUInt_t task_id, PxUInt_t arg,	TC_CSA_t* p_CSA){
...
/* TRAP CLASS -	2	*/
PxBool_t Px_trap_hdl_2(PxUInt_t trapclass, PxUInt_t tin , PxUInt_t task_id, PxUInt_t arg,	TC_CSA_t* p_CSA){
...
/* TRAP CLASS -	3	*/
PxBool_t Px_trap_hdl_3(PxUInt_t trapclass, PxUInt_t tin , PxUInt_t task_id, PxUInt_t arg,	TC_CSA_t* p_CSA){
...
/* TRAP CLASS -	4	*/
PxBool_t Px_trap_hdl_4(PxUInt_t trapclass, PxUInt_t tin , PxUInt_t task_id, PxUInt_t arg,	TC_CSA_t* p_CSA){
...
/* TRAP CLASS -	5	*/
PxBool_t Px_trap_hdl_5(PxUInt_t trapclass, PxUInt_t tin , PxUInt_t task_id, PxUInt_t arg,	TC_CSA_t* p_CSA){
...
/* TRAP CLASS -	6	*/
PxBool_t Px_trap_hdl_6(PxUInt_t trapclass, PxUInt_t tin , PxUInt_t task_id, PxUInt_t arg,	TC_CSA_t* p_CSA){
...
/* TRAP CLASS -	7	*/
PxBool_t Px_trap_hdl_7(PxUInt_t trapclass, PxUInt_t tin , PxUInt_t task_id, PxUInt_t arg,	TC_CSA_t* p_CSA){
