...
//Module 0
	{
		TRUE,						//Module enable
		&MODULE_QSPI0,				//Pointer to the SPI-Module
...
//Module 1
	{
		FALSE,						//Module enable
		&MODULE_QSPI1,				//Pointer to the SPI-Module
		RxSel_a,					//Pin selection
...
//Module 2
	{
		TRUE,						//Module enable
		&MODULE_QSPI2,				//Pointer to the SPI-Module
		RxSel_b,					//Pin selection
		10000000,					//Max BaudRate
...
//Module 3
	{
		TRUE,						//Module enable
		&MODULE_QSPI3,				//Pointer to the SPI-Module
		RxSel_a,					//Pin selection
		10000000,					//Max BaudRate
...
//Module 4
	{
		FALSE,						//Module enable
		&MODULE_QSPI4,				//Pointer to the SPI-Module
		RxSel_a,					//Pin selection
		10000000,					//Max BaudRate
	...
	{
		FALSE,						//Module enable
		&MODULE_QSPI5,				//Pointer to the SPI-Module
		RxSel_a,					//Pin selection
		10000000,					//Max BaudRate
